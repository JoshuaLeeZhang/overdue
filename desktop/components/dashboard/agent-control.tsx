			...
			<div className="relative flex items-center gap-4">
				...
				<div className="flex flex-1 flex-col gap-1">
					...
					<span className="text-xs text-muted-foreground">
						{agentState === "idle" &&
							"Start the agent to begin processing queued tasks and monitoring deadlines."}
						{agentState === "starting" &&
							"Connecting to your courses and syncing assignments..."}
						{agentState === "running" &&
							"Processing tasks. Monitoring courses for new deadlines."}
						{agentState === "stopping" &&
							"Finishing current tasks before shutting down..."}
					</span>
				</div>
			...
			{agentState === "running" && (
				<div className="relative mt-4 flex items-center gap-6 border-t border-primary/10 pt-3">
					<div className="flex items-center gap-1.5 text-xs text-muted-foreground">
						...
						<span>
							<span className="font-medium text-foreground">2</span> tasks
							processing
						</span>
					</div>
					<div className="flex items-center gap-1.5 text-xs text-muted-foreground">
						...
						<span>
							<span className="font-medium text-foreground">2</span> queued
						</span>
					</div>
					<div className="flex items-center gap-1.5 text-xs text-muted-foreground">
						<Shield className="size-3 text-chart-2" />
						<span>
							<span className="font-medium text-foreground">6</span> courses
							monitored
						</span>
					</div>
				</div>
