...
import { ListTodo, CheckCircle2, Clock, AlertTriangle, BookOpen, CalendarClock } from "lucide-react"
...
const upcomingDeadlines = [
  { title: "Homework Set #7", course: "MATH 260", due: "Today 6:00 PM", urgent: true },
  { title: "Discussion Board Post #8", course: "PSY 101", due: "Today 11:59 PM", urgent: true },
  { title: "Lab Report Review", course: "CHEM 201", due: "Tomorrow 5:00 PM", urgent: false },
  { title: "Reading Quiz Ch. 12", course: "HIST 150", due: "Mar 2", urgent: false },
  { title: "Peer Review Draft", course: "ENG 202", due: "Mar 3", urgent: false },
]
